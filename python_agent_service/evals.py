...
from python_agent_service.langfuse_support import (
    build_run_name,
    ensure_dataset,
    run_experiment,
    score_trace,
...
from python_agent_service.models import AgentChatResponse, EvalCase, EvalSuiteResult
from python_agent_service.ragas_support import evaluate_ragas_case
    ...
    def _run_langfuse_experiment(self, suite: str, cases: list[dict]) -> None:
        ...
        def tool_evaluator(item, output):
            ...
            return {
                "name": "tool_match",
                "value": score,
                "comment": f"expected={expected_tool}, actual={tools}",
            }
